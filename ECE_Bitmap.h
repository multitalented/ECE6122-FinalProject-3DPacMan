...
This is the bitmap reading file that was provided by Dr. Jeffrey Hurley
to be used with this pac-man code for texturing the ghosts and pac-man

It defines structs and functions that allow input of a .bmp file for texture
